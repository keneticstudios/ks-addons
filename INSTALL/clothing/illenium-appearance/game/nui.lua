...
RegisterNUICallback("appearance_change_component", function(component, cb)
    ...
    -- [NEW] Track changes for ks-addons
    TriggerEvent('illenium-appearance:client:TrackChange', 'component', component.component_id, component.drawable, component.texture)
...
RegisterNUICallback("appearance_change_prop", function(prop, cb)
    ...
    -- [NEW] Track changes for ks-addons
    TriggerEvent('illenium-appearance:client:TrackChange', 'prop', prop.prop_id, prop.drawable, prop.texture)
